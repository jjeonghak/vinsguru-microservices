...
/**
 * to demo a simple kafka producer using SASL SSL
 */
@Slf4j
public class KafkaProducer {
	...
	public static void main(String[] args) {
		...
		Map<String, Object> producerConfig = Map.of(
				...
				SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, Paths.get("src/main/resources/kafka.truststore.jks").toAbsolutePath(),
